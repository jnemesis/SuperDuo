...
public class ScoresAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        mHolder.home_crest.setImageResource(Utilities.getTeamCrestByTeamName(homeName));
        mHolder.away_crest.setImageResource(Utilities.getTeamCrestByTeamName(awayName));
